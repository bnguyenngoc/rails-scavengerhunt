...
ActiveRecord::Schema.define(version: 20_190_103_185_131) do
  ...
  create_table 'notes', force: :cascade do |t|
    t.bigint 'team_challenge_id'
    t.bigint 'user_id'
    t.text 'content'
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['team_challenge_id'], name: 'index_notes_on_team_challenge_id'
  ...
  add_foreign_key 'notes', 'team_challenges'
